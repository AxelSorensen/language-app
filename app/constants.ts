...
export const getLanguageInstructions = (nativeLanguage: string) => ({
  ...
  ar: `IMPORTANT: The input is in Romanized Modern Standard Arabic (MSA). Always use MSA, not any specific dialect. Translate from Romanized MSA to ${nativeLanguage}. Note that Arabic is written right-to-left, but provide the ${nativeLanguage} translation normally.`,
...
export const WORD_LANGUAGE_INSTRUCTIONS: Record<string, string> = {
  ...
  ar: `The input is in Romanized Modern Standard Arabic (MSA). Always use MSA, not any specific dialect. If you need to make corrections, always provide the correction in Romanized MSA, not in Arabic script.`,
...
export const OUTPUT_LANGUAGE_INSTRUCTIONS: Record<string, string> = {
  ...
  ar: "IMPORTANT: Output the translation in Romanized Modern Standard Arabic (MSA). Always use MSA, not any specific dialect, and do not use Arabic script.",
